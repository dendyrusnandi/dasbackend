...
remote_dir = "/home/rdpuser/dbmcz/"  # Remote directory to copy
local_dir = "C:/xampp/html/dasbackend/"  # Local directory to save the files
...
while True:
    ...
    time.sleep(5)  # Wait for 5 seconds before downloading again
